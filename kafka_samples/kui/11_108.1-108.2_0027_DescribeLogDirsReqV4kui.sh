...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsReqV4kui/100000.in  istuple:N  msg:"00 00 00 28 00 23 00 04 00 00 00 1b 00 1b 6b 61 66 6b 61 2d 75 69 2d 61 64 6d 69 6e 2d 31 37 34"
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsReqV4kui/100010.in  istuple:N  msg:"36 36 34 38 32 32 37 2d 31 00 00 00"
EOF
atf_comp -capture kapi.DescribeLogDirsReqV4kui
atf_comp -run     kapi.DescribeLogDirsReqV4kui
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.DescribeLogDirsRequest  request_api_version:4  correlation_id:27  client_id:kafka-ui-admin-1746648227-1
