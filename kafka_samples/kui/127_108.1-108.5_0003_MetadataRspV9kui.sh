...
acr.insert  atfdb.targs comptest:kapi.MetadataRspV9kui args:"-decode -hex -rsp:- -apiver:3.3.9"
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV9kui/100000.in  istuple:N  msg:"00 00 00 99 00 00 00 03 00 00 00 00 00 05 00 00 00 01 15 64 65 76 2e 61 6b 2d 38 2e 6b 61 66 6b"
...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV9kui/100040.in  istuple:N  msg:"2e 65 78 74 00 00 04 17 00 00 09 64 65 76 2e 61 6b 2d 38 00 00 00 03 01 80 00 00 00 00"
EOF
