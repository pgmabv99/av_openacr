...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataReqV12kui/100010.in  istuple:N  msg:"36 36 34 38 33 38 36 2d 31 00 01 01 00 00"
EOF
atf_comp -capture kapi.MetadataReqV12kui
atf_comp -run     kapi.MetadataReqV12kui
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.MetadataRequest  request_api_version:12  correlation_id:1  client_id:kafka-ui-admin-1746648386-1  allow_auto_topic_creation:Y  include_cluster_authorized_operations:N  include_topic_authorized_operations:N
