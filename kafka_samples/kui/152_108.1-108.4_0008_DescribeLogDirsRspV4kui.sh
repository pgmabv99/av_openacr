...
acr.insert  atfdb.targs comptest:kapi.DescribeLogDirsRspV4kui args:"-decode -hex -rsp:- -apiver:8.35.4"
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsRspV4kui/100000.in  istuple:N  msg:"00 00 00 b1 00 00 00 08 00 00 00 00 00 00 00 05 00 00 15 2f 6d 6e 74 2f 64 61 74 61 2d 31 2f 64"
