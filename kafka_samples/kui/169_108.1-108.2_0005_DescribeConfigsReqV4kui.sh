...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeConfigsReqV4kui/100010.in  istuple:N  msg:"36 36 34 38 33 38 36 2d 31 00 02 04 02 31 00 00 00 00 00"
EOF
atf_comp -capture kapi.DescribeConfigsReqV4kui
atf_comp -run     kapi.DescribeConfigsReqV4kui
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.DescribeConfigsRequest  request_api_version:4  correlation_id:5  client_id:kafka-ui-admin-1746648386-1  resources.0:"kafka2.DescribeConfigsResource32q  resource_type:4  resource_name:1"  include_synonyms:N  include_documentation:N
