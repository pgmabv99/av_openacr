...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3kui/100010.in  istuple:N  msg:"36 36 34 38 33 38 36 2d 31 00 12 61 70 61 63 68 65 2d 6b 61 66 6b 61 2d 6a 61 76 61 06 33 2e 35"
...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:10  client_id:kafka-ui-admin-1746648386-1  client_software_name:apache-kafka-java  client_software_version:3.5.0
