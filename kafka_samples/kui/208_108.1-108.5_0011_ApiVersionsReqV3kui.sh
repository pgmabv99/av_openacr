...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:11  client_id:kafka-ui-admin-1746648386-1  client_software_name:apache-kafka-java  client_software_version:3.5.0
