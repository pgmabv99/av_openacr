...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeClusterReqV0kui/100000.in  istuple:N  msg:"00 00 00 28 00 3c 00 00 00 00 00 25 00 1b 6b 61 66 6b 61 2d 75 69 2d 61 64 6d 69 6e 2d 31 37 34"
...
# kafka2.DescribeClusterRequest  request_api_version:0  correlation_id:37  client_id:kafka-ui-admin-1746648386-1  include_cluster_authorized_operations:Y  endpoint_type:1  include_fenced_brokers:N
