...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataReqV12kui/100000.in  istuple:N  msg:"00 00 00 2a 00 03 00 0c 00 00 00 2b 00 1b 6b 61 66 6b 61 2d 75 69 2d 61 64 6d 69 6e 2d 31 37 34"
...
# kafka2.MetadataRequest  request_api_version:12  correlation_id:43  client_id:kafka-ui-admin-1746648386-1  allow_auto_topic_creation:Y  include_cluster_authorized_operations:N  include_topic_authorized_operations:N
