...
# kafka2.DescribeClusterRequest  request_api_version:0  correlation_id:23  client_id:kafka-ui-admin-1746648386-1  include_cluster_authorized_operations:Y  endpoint_type:1  include_fenced_brokers:N
