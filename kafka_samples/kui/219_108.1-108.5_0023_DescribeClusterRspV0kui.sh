...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeClusterRspV0kui/100000.in  istuple:N  msg:"00 00 00 9b 00 00 00 17 00 00 00 00 00 00 00 00 09 64 65 76 2e 61 6b 2d 38 00 00 00 04 05 00 00"
...
# kafka2.DescribeClusterResponse  request_api_version:0  correlation_id:23  throttle_time_ms:0  error_code:0  endpoint_type:1  cluster_id:dev.ak-8  controller_id:4  brokers.0:"kafka2.DescribeClusterBroker60a  broker_id:1  host:dev.ak-8.kafka-1.ext  port:1031  is_fenced:N"  brokers.1:"kafka2.DescribeClusterBroker60a  broker_id:2  host:dev.ak-8.kafka-2.ext  port:1039  is_fenced:N"  brokers.2:"kafka2.DescribeClusterBroker60a  broker_id:3  host:dev.ak-8.kafka-3.ext  port:1043  is_fenced:N"  brokers.3:"kafka2.DescribeClusterBroker60a  broker_id:4  host:dev.ak-8.kafka-4.ext  port:1047  is_fenced:N"  cluster_authorized_operations:8096
