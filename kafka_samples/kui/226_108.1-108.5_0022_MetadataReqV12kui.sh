...
# kafka2.MetadataRequest  request_api_version:12  correlation_id:22  client_id:kafka-ui-admin-1746648386-1  allow_auto_topic_creation:Y  include_cluster_authorized_operations:N  include_topic_authorized_operations:N
