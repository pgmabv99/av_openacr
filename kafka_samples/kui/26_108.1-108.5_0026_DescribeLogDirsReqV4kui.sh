...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsReqV4kui/100000.in  istuple:N  msg:"00 00 00 28 00 23 00 04 00 00 00 1a 00 1b 6b 61 66 6b 61 2d 75 69 2d 61 64 6d 69 6e 2d 31 37 34"
...
# kafka2.DescribeLogDirsRequest  request_api_version:4  correlation_id:26  client_id:kafka-ui-admin-1746648227-1
