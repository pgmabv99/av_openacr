...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeClusterReqV0kui/100010.in  istuple:N  msg:"36 36 34 38 32 32 37 2d 31 00 00 00"
EOF
atf_comp -capture kapi.DescribeClusterReqV0kui
atf_comp -run     kapi.DescribeClusterReqV0kui
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.DescribeClusterRequest  request_api_version:0  correlation_id:3  client_id:kafka-ui-admin-1746648227-1  include_cluster_authorized_operations:N  endpoint_type:1  include_fenced_brokers:N
