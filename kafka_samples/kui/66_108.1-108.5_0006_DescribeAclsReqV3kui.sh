...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeAclsReqV3kui/100010.in  istuple:N  msg:"36 36 34 38 33 34 35 2d 31 00 01 00 01 00 00 01 01 00"
EOF
atf_comp -capture kapi.DescribeAclsReqV3kui
atf_comp -run     kapi.DescribeAclsReqV3kui
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.DescribeAclsRequest  request_api_version:3  correlation_id:6  client_id:kafka-ui-admin-1746648345-1  resource_type_filter:1  pattern_type_filter:1  operation:1  permission_type:1
