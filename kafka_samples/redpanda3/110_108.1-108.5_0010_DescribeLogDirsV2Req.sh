...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsReqV2rdp/100000.in  istuple:N  msg:"00 00 00 1d 00 23 00 02 00 00 00 0a 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 00  "
...
# kafka2.DescribeLogDirsRequest  request_api_version:2  correlation_id:10  client_id:redpanda-console
