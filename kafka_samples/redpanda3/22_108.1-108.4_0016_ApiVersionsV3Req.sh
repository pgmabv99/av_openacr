...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3rdp/100000.in  istuple:N  msg:"00 00 00 2d 00 12 00 03 00 00 00 10 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 0a  "
...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:16  client_id:redpanda-console  client_software_name:RPConsole  client_software_version:v2.8.2
