...
acr.insert  atfdb.tmsg  tmsg:kapi.FetchReqV11rdp/100010.in  istuple:N  msg:"ff ff 00 00 00 01 00 00 00 01 00 00 00 01 00 08 c5 93 e0 ff ff ff ff 00 00 00 00 00 00 00 00 00  "
...
# kafka2.FetchRequest  request_api_version:11  correlation_id:0  client_id:redpanda-console  replica_id:-1  replica_state:"kafka2.ReplicaState1q  replica_id:-1  replica_epoch:-1"  max_wait_ms:1  min_bytes:1  max_bytes:1  isolation_level:0  session_id:147166176  session_epoch:-1  rack_id:""
