...
acr.insert  atfdb.tmsg  tmsg:kapi.InitProducerIdRspV3rdp/100000.in  istuple:N  msg:"00 00 00 16 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 07 d0 00 00 00 "
EOF
atf_comp -capture kapi.InitProducerIdRspV3rdp
atf_comp -run     kapi.InitProducerIdRspV3rdp
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.InitProducerIdResponse  request_api_version:3  correlation_id:1  throttle_time_ms:0  error_code:0  producer_id:2000  producer_epoch:0  ongoing_txn_producer_id:-1  ongoing_txn_producer_epoch:-1
