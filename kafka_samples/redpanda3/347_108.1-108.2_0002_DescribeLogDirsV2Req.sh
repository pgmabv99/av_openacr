...
# kafka2.DescribeLogDirsRequest  request_api_version:2  correlation_id:2  client_id:redpanda-console  topics.0:"kafka2.DescribableLogDirTopic35q  topic:av1  partitions.0:2"
