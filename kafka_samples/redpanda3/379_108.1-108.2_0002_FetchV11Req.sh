...
acr.insert  atfdb.tmsg  tmsg:kapi.FetchReqV11rdp/100010.in  istuple:N  msg:"ff ff 00 00 13 88 00 00 00 01 00 4c 4b 40 00 13 21 29 91 00 00 00 01 00 00 00 01 00 03 61 76 31  "
...
# kafka2.FetchRequest  request_api_version:11  correlation_id:2  client_id:redpanda-console  replica_id:-1  replica_state:"kafka2.ReplicaState1q  replica_id:-1  replica_epoch:-1"  max_wait_ms:5000  min_bytes:1  max_bytes:5000000  isolation_level:0  session_id:320940433  session_epoch:1  topics.0:'kafka2.FetchTopic1q  topic:av1  topic_id:00000000-0000-0000-0000-000000000000  partitions.0:"kafka2.FetchPartition1q  partition:2  current_leader_epoch:0  fetch_offset:0  last_fetched_epoch:-1  log_start_offset:-1  partition_max_bytes:1048576  replica_directory_id:00000000-0000-0000-0000-000000000000"'  rack_id:""
