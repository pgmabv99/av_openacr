...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeConfigsReqV3rdp/100000.in  istuple:N  msg:"00 00 00 2a 00 20 00 03 00 00 00 00 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 00  "
...
# kafka2.DescribeConfigsRequest  request_api_version:3  correlation_id:0  client_id:redpanda-console  resources.0:"kafka2.DescribeConfigsResource32q  resource_type:2  resource_name:av1"  include_synonyms:Y  include_documentation:Y
