...
acr.insert  atfdb.tmsg  tmsg:kapi.ListOffsetsRspV5rdp/100000.in  istuple:N  msg:"00 00 00 2f 00 00 00 04 00 00 00 00 00 00 00 01 00 03 61 76 31 00 00 00 01 00 00 00 01 00 00 ff  "
...
# kafka2.ListOffsetsResponse  request_api_version:5  correlation_id:4  throttle_time_ms:0  topics.0:'kafka2.ListOffsetsTopicResponse2a  name:av1  partitions.0:"kafka2.ListOffsetsPartitionResponse2a  partition_index:1  error_code:0  timestamp:-1  offset:0  leader_epoch:0"'
