...
acr.insert  atfdb.tmsg  tmsg:kapi.ListOffsetsReqV5rdp/100000.in  istuple:N  msg:"00 00 00 3c 00 02 00 05 00 00 00 00 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 00  "
...
# kafka2.ListOffsetsRequest  request_api_version:5  correlation_id:0  client_id:redpanda-console  replica_id:0  isolation_level:0  topics.0:'kafka2.ListOffsetsTopic2q  name:av1  partitions.0:"kafka2.ListOffsetsPartition2q  partition_index:1  current_leader_epoch:-1  timestamp:-2"'  timeout_ms:0
