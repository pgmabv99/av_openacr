...
acr.insert  atfdb.targs comptest:kapi.MetadataRspV9rdp args:"-decode -hex -rsp:- -apiver:7.3.9"
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV9rdp/100000.in  istuple:N  msg:"00 00 00 f4 00 00 00 07 00 00 00 00 00 05 00 00 00 01 15 64 65 76 2e 61 6b 2d 38 2e 6b 61 66 6b  "
...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV9rdp/100040.in  istuple:N  msg:"2e 65 78 74 00 00 04 17 00 00 09 64 65 76 2e 61 6b 2d 38 00 00 00 02 02 00 00 04 61 76 31 00 04  "
