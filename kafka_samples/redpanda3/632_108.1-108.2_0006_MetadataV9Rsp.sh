...
acr.insert  atfdb.targs comptest:kapi.MetadataRspV9rdp args:"-decode -hex -rsp:- -apiver:6.3.9"
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV9rdp/100000.in  istuple:N  msg:"00 00 00 f4 00 00 00 06 00 00 00 00 00 05 00 00 00 01 15 64 65 76 2e 61 6b 2d 38 2e 6b 61 66 6b  "
