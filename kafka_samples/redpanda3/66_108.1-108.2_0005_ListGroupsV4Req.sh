...
acr.insert  atfdb.tmsg  tmsg:kapi.ListGroupsReqV4rdp/100000.in  istuple:N  msg:"00 00 00 1d 00 10 00 04 00 00 00 05 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 01  "
...
# kafka2.ListGroupsRequest  request_api_version:4  correlation_id:5  client_id:redpanda-console
