...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeAclsReqV2rdp/100000.in  istuple:N  msg:"00 00 00 23 00 1d 00 02 00 00 00 05 00 10 72 65 64 70 61 6e 64 61 2d 63 6f 6e 73 6f 6c 65 00 01  "
...
# kafka2.DescribeAclsRequest  request_api_version:2  correlation_id:5  client_id:redpanda-console  resource_type_filter:1  pattern_type_filter:1  operation:1  permission_type:1
