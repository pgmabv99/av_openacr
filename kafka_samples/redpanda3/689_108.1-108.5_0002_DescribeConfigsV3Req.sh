...
# kafka2.DescribeConfigsRequest  request_api_version:3  correlation_id:2  client_id:redpanda-console  resources.0:"kafka2.DescribeConfigsResource32q  resource_type:4  resource_name:4"  include_synonyms:Y  include_documentation:Y
