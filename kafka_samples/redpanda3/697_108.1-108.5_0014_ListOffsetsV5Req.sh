...
# kafka2.ListOffsetsRequest  request_api_version:5  correlation_id:14  client_id:redpanda-console  replica_id:0  isolation_level:0  topics.0:'kafka2.ListOffsetsTopic2q  name:av1  partitions.0:"kafka2.ListOffsetsPartition2q  partition_index:1  current_leader_epoch:-1  timestamp:-2"'  timeout_ms:0
