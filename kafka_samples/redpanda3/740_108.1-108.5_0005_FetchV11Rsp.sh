...
acr.insert  atfdb.tmsg  tmsg:kapi.FetchRspV11rdp/100000.in  istuple:N  msg:"00 00 00 12 00 00 00 05 00 00 00 00 00 00 41 1a 65 95 00 00 00 00 "
EOF
atf_comp -capture kapi.FetchRspV11rdp
atf_comp -run     kapi.FetchRspV11rdp
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.FetchResponse  request_api_version:11  correlation_id:5  throttle_time_ms:0  error_code:0  session_id:1092248981
