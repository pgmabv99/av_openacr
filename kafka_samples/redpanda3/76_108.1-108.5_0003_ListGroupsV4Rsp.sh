...
acr.insert  atfdb.targs comptest:kapi.ListGroupsRspV4rdp args:"-decode -hex -rsp:- -apiver:3.16.4"
acr.insert  atfdb.tmsg  tmsg:kapi.ListGroupsRspV4rdp/100000.in  istuple:N  msg:"00 00 00 0d 00 00 00 03 00 00 00 00 00 00 00 01 00 "
EOF
