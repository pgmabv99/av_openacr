...
acr.insert  atfdb.tmsg  tmsg:kapi.DescribeLogDirsRspV2rdp/100000.in  istuple:N  msg:"00 00 00 59 00 00 00 0a 00 00 00 00 00 03 00 00 15 2f 6d 6e 74 2f 64 61 74 61 2d 31 2f 64 65 76  "
...
# kafka2.DescribeLogDirsResponse  request_api_version:2  correlation_id:10  throttle_time_ms:0  error_code:0  results.0:"kafka2.DescribeLogDirsResult35a  error_code:0  log_dir:/mnt/data-1/dev.ak-8  topics.0:'kafka2.DescribeLogDirsTopic35a  name:av1  partitions.0:\"kafka2.DescribeLogDirsPartition35a  partition_index:1  partition_size:0  offset_lag:0  is_future_key:N\"'  total_bytes:-1  usable_bytes:-1"  results.1:"kafka2.DescribeLogDirsResult35a  error_code:0  log_dir:/mnt/data-2/dev.ak-8  total_bytes:-1  usable_bytes:-1"
