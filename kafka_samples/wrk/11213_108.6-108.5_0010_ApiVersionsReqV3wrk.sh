...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3wrk/100000.in  istuple:N  msg:"00 00 00 2e 00 12 00 03 00 00 00 0a 00 0a 70 72 6f 64 75 63 65 72 2d 31 00 12 61 70 61 63 68 65"
...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:10  client_id:producer-1  client_software_name:apache-kafka-java  client_software_version:3.6.1
