...
acr.insert  atfdb.targs comptest:kapi.MetadataRspV12wrk args:"-decode -hex -pretty -rsp:- -apiver:13.3.12"
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV12wrk/100000.in  istuple:N  msg:"00 00 00 76 00 00 00 0d 00 00 00 00 00 04 00 00 00 02 15 64 65 76 2e 61 6b 2d 38 2e 6b 61 66 6b"
