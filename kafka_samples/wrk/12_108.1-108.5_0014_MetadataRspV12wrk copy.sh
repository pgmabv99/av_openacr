...
acr.insert  atfdb.targs comptest:kapi.MetadataRspV12wrk args:"-decode -hex -pretty -rsp:- -apiver:14.3.12"
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV12wrk/100000.in  istuple:N  msg:"00 00 00 76 00 00 00 0e 00 00 00 00 00 04 00 00 00 02 15 64 65 76 2e 61 6b 2d 38 2e 6b 61 66 6b"
...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV12wrk/100030.in  istuple:N  msg:"34 2e 65 78 74 00 00 04 17 00 00 09 64 65 76 2e 61 6b 2d 38 00 00 00 03 01 00"
EOF
