...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3wrk/100000.in  istuple:N  msg:"00 00 00 31 00 12 00 03 00 00 00 02 00 0d 61 64 6d 69 6e 63 6c 69 65 6e 74 2d 31 00 12 61 70 61"
...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:2  client_id:adminclient-1  client_software_name:apache-kafka-java  client_software_version:3.6.1
