...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3wrk/100000.in  istuple:N  msg:"00 00 00 3e 00 12 00 03 00 00 00 01 00 1a 63 6f 6e 73 75 6d 65 72 2d 73 75 62 2d 30 30 30 2d 75"
...
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:1  client_id:consumer-sub-000-ufMJIvQ-1  client_software_name:apache-kafka-java  client_software_version:3.6.1
