...
acr.insert  atfdb.targs comptest:kapi.ApiVersionsRspV3wrk args:"-decode -hex -pretty -rsp:- -apiver:10.18.3"
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsRspV3wrk/100000.in  istuple:N  msg:"00 00 01 f3 00 00 00 0a 00 00 3e 00 00 00 00 00 0b 00 00 01 00 00 00 11 00 00 02 00 00 00 09 00"
...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsRspV3wrk/100140.in  istuple:N  msg:"65 74 61 64 61 74 61 2e 76 65 72 73 69 6f 6e 00 01 00 15 00 01 08 00 00 00 00 00 00 00 67 02 17"
