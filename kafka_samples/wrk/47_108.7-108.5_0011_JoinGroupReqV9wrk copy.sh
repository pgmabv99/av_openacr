...
acr.insert  atfdb.tmsg  tmsg:kapi.JoinGroupReqV9wrk/100000.in  istuple:N  msg:"00 00 00 fb 00 0b 00 09 00 00 00 0b 00 1a 63 6f 6e 73 75 6d 65 72 2d 73 75 62 2d 30 30 30 2d 75"
...
acr.insert  atfdb.tmsg  tmsg:kapi.JoinGroupReqV9wrk/100060.in  istuple:N  msg:"ff ff ff 00 00 00 00 ff ff ff ff ff ff 00 30 72 65 62 61 6c 61 6e 63 65 20 66 61 69 6c 65 64 20"
acr.insert  atfdb.tmsg  tmsg:kapi.JoinGroupReqV9wrk/100070.in  istuple:N  msg:"64 75 65 20 74 6f 20 4e 6f 74 43 6f 6f 72 64 69 6e 61 74 6f 72 45 78 63 65 70 74 69 6f 6e 00"
EOF
atf_comp -capture kapi.JoinGroupReqV9wrk
atf_comp -run     kapi.JoinGroupReqV9wrk
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.JoinGroupRequest  request_api_version:9  correlation_id:11  client_id:consumer-sub-000-ufMJIvQ-1  group_id:sub-000-ufMJIvQ  session_timeout_ms:45000  rebalance_timeout_ms:300000  member_id:""  protocol_type:consumer  protocols.0:'kafka2.JoinGroupRequestProtocol11q  name:range  metadata:"00 03 00 00 00 01 00 1a 74 65 73 74 2d 74 6f 70 69 63 2d 30 30 30 30 30 30 30 2d 6f 57 70 76 64 51 4d ff ff ff ff 00 00 00 00 ff ff ff ff ff ff"'  protocols.1:'kafka2.JoinGroupRequestProtocol11q  name:cooperative-sticky  metadata:"00 03 00 00 00 01 00 1a 74 65 73 74 2d 74 6f 70 69 63 2d 30 30 30 30 30 30 30 2d 6f 57 70 76 64 51 4d 00 00 00 04 ff ff ff ff 00 00 00 00 ff ff ff ff ff ff"'  reason:"rebalance failed due to NotCoordinatorException"
...
reason:"rebalance failed due to NotCoordinatorException"
