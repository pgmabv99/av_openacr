...
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3wrk/100000.in  istuple:N  msg:"00 00 00 31 00 12 00 03 00 00 00 00 00 0d 61 64 6d 69 6e 63 6c 69 65 6e 74 2d 31 00 12 61 70 61"
acr.insert  atfdb.tmsg  tmsg:kapi.ApiVersionsReqV3wrk/100010.in  istuple:N  msg:"63 68 65 2d 6b 61 66 6b 61 2d 6a 61 76 61 06 33 2e 36 2e 31 00"
EOF
atf_comp -capture kapi.ApiVersionsReqV3wrk
atf_comp -run     kapi.ApiVersionsReqV3wrk
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.ApiVersionsRequest  request_api_version:3  correlation_id:0  client_id:adminclient-1  client_software_name:apache-kafka-java  client_software_version:3.6.1
