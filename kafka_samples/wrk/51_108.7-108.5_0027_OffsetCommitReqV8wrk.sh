...
acr.insert  atfdb.tmsg  tmsg:kapi.OffsetCommitReqV8wrk/100000.in  istuple:N  msg:"00 00 00 ab 00 08 00 08 00 00 00 1b 00 1a 63 6f 6e 73 75 6d 65 72 2d 73 75 62 2d 30 30 30 2d 75"
...
acr.insert  atfdb.tmsg  tmsg:kapi.OffsetCommitReqV8wrk/100040.in  istuple:N  msg:"74 65 73 74 2d 74 6f 70 69 63 2d 30 30 30 30 30 30 30 2d 6f 57 70 76 64 51 4d 02 00 00 00 01 00"
acr.insert  atfdb.tmsg  tmsg:kapi.OffsetCommitReqV8wrk/100050.in  istuple:N  msg:"00 00 00 00 00 00 01 ff ff ff ff 01 00 00 00"
EOF
atf_comp -capture kapi.OffsetCommitReqV8wrk
atf_comp -run     kapi.OffsetCommitReqV8wrk
retcode=$?; echo "Return code: $retcode"; exit $retcode
# kafka2.OffsetCommitRequest  request_api_version:8  correlation_id:27  client_id:consumer-sub-000-ufMJIvQ-1  group_id:sub-000-ufMJIvQ  generation_id_or_member_epoch:1  member_id:consumer-sub-000-ufMJIvQ-1-9f32b49f-ab9d-49ad-9559-863e15ab7260  retention_time_ms:-1  topics.0:"kafka2.OffsetCommitRequestTopic8q  name:test-topic-0000000-oWpvdQM  partitions.0:'kafka2.OffsetCommitRequestPartition8q  partition_index:1  committed_offset:1  committed_leader_epoch:-1  committed_metadata:\"\"'"
