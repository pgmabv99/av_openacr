...
acr.insert  atfdb.tmsg  tmsg:kapi.MetadataRspV12wrk/100030.in  istuple:N  msg:"34 2e 65 78 74 00 00 04 17 00 00 09 64 65 76 2e 61 6b 2d 38 00 00 00 02 01 00"
EOF
