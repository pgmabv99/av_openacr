#
# Generated by omcli
# Cluster:dev.ak-8 Node:dev.ak-8.kafka-2
#
cat << 'HOSTS' > omhosts
# Generated by omcli
...
cat << 'EOF' >dev.kafka-02.properties
#
# Generated by omcli
# Cluster:dev.ak-8 Node:dev.ak-8.kafka-2
#
advertised.listeners=PLAINTEXT://dev.ak-8.kafka-2.ext:1039,SSL://dev.ak-8.kafka-2.ext:1041,INTERNAL://dev.ak-8.kafka-2.int:1105
...
listeners=PLAINTEXT://dev.ak-8.kafka-2.ext:1039,SSL://dev.ak-8.kafka-2.ext:1041,INTERNAL://dev.ak-8.kafka-2.int:1105,CONTROLLER://dev.ak-8.kafka-2.int:1051
log.dirs=dev.ak-8
...
sed -i "s/^log\.dirs=.*/log.dirs=${log//\//\\/}/" dev.kafka-02.properties
ln -sfr dev.kafka-02.properties server.properties
}
#
#
...
export KAFKA_OPTS="-javaagent:/home/kafkausr/jmx_prometheus_javaagent.jar=dev.ak-8.kafka-2.ext:1052:/home/kafkausr/jmx_prometheus.yaml -Djava.net.preferIPv4Stack=true"
export JMX_PORT=1073
export KAFKA_JMX_OPTS="-Dcom.sun.management.jmxremote.host=dev.ak-8.kafka-2.ext \
                      -Djava.rmi.server.hostname=dev.ak-8.kafka-2.ext \
                      -Dcom.sun.management.jmxremote.port=1073 \
...
for i in {1..10}; do lsof -i :1073 >/dev/null && { echo; echo $(hostname):success; exit 0; }; echo -n .; sleep 1; done;
...
function status_kafka_broker {
 lsof -P -i :1073 || { echo "====Not running"; }
}
function metrics_kafka_broker {
curl http://dev.ak-8.kafka-2.ext:1052/metrics
}
#
     copy_server_properties
     copy_prometheus_properties
echo "script:info  node:dev.kafka-02 omnode:dev.ak-8.kafka-2 option:$1 "
case $1 in
     start)
     stop_kafka_broker
     start_kafka_broker
