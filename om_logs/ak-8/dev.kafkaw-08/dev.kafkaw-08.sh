#
# Generated by omcli
# Cluster:dev.ak-8 Node:dev.ak-8.kafkaw-1
#
cat << 'HOSTS' > omhosts
# Generated by omcli
...
for i in {1..60}; do lsof -i :1118 >/dev/null && { echo; echo $(hostname):success; exit 0; } || echo -n .; sleep 1; done;
...
#
#
echo "script:info  node:dev.kafkaw-08 omnode:dev.ak-8.kafkaw-1 option:$1 "
case $1 in
     start | start_clean)
     stop_kafka_worker
     start_kafka_worker
